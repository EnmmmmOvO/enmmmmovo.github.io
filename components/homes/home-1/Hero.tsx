            ...
            <div className="mxd-hero-01__top">
              <div className="mxd-hero-01__title-wrap">
                ...
                <div className="mxd-hero-01__marquee loading__item">
                  <VelocityMarquee className="marquee marquee-right--gsap" direction="left">
                    {/* single item */}
                ...
                <h1 className="hero-01-title">
                  <span className="hero-01-title__row loading__item">
                    <em className="hero-01-title__item hero-01-title__title">William</em>
                  ...
                  <span className="hero-01-title__row loading__item">
                    ...
                    <em className="hero-01-title__item hero-01-title__subtitle">Focus on Full-Stack | AI</em>
                  </span>
                </h1>
              </div>
            </div>
